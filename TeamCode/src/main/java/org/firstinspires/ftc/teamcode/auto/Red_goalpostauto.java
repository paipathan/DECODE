...
@Autonomous(name="Red_goalpostauto", group="Auto")
public class Red_goalpostauto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        dt.follower.setStartingPose(new Pose(116.94749124854141, 130.0536756126021, Math.toRadians(36)));
